...
/** FB FC12 */
  protected ConveyorCTLCentralClient FC12 = new ConveyorCTLCentralClient() ;
...
public TwoConCtlCentralClient(){
    ...
    PE_EVENT.connectTo(FC12.I_PE_EVENT);
    FC12.REQUEST_TOKE.connectTo(REQUEST_TOKE);
    FC12.RELEASE_TOKE.connectTo(RELEASE_TOKE);
    GRANTED_TOKE.connectTo(FC12.GRANTED_TOKE);
    FC12.connectIVNoException("Block",Block);
    FC12.connectIVNoException("Candidate",Candidate);
